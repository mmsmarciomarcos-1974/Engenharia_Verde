...
for rodada in range(1, 301):
    ...
    if rodada % 10 == 0:
        ...
        with open(arquivo_csv, mode="a", newline="", encoding="utf-8") as f:
            ...
            cpu_medio_grafico.append(cpu_total / 5)

            print(f"💡 Energia acumulada total até agora: {energia_total_acumulada:.2f}W")

            # --- Atualiza gráficos ---
            axes[0].cla()
            axes[0].plot(rodadas_grafico, energia_acumulada_grafico, marker='o', color='orange')
...
plt.ioff()
plt.show()  # mantém os gráficos após execução
